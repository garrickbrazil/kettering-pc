...
public class Directory {
	...
	/********************************************************************
	 * Constructor: Directory
	 * Purpose: create a directory and search
	 * Parameters:
	 * 		String search: what to search for
	 * 		String type: student or faculty?
	/*******************************************************************/
	public Directory(String search, String type){
		...
		try{
			...
			// Student or Faculty ?			
			if(type.equals("student")) this.studentQuery = new Gson().fromJson(json, StudentQuery.class);
			else if (type.equals("faculty")) this.facultyQuery = new Gson().fromJson(json, FacultyQuery.class); 
